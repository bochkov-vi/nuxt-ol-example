...
import useDeckgl, { type CoordinateExtractor, FROM_EVENT, useProvideDeckLayerIds } from '~/components/ol/deckgl/use.deckgl'
...
const _pickingInfo = defineModel('pickingInfo', {
  type: Object as PropType<PickingInfo & Record<string, unknown>>
})
...
<template>
  <slot name="default" :feature="_feature" :coordinate="_coordinate" :picking-info="_pickingInfo" :clear="clear" />
</template>
